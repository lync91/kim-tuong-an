...
async function createWindow() {
    ...
    mainWindow = new BrowserWindow({ x, y, width, height, minWidth: 700, minHeight: 700, maxWidth: 1920, maxHeight: 1080,webPreferences: { enableRemoteModule: true, nodeIntegration: true }, backgroundColor: '#2f3243' });
